  ...
  return (
    <Center h="100vh" p="md">
      <Stack align="center" gap="lg" maw={360} w="100%">
        ...
        <Text size="xl" fw={700} ta="center">{t('setupPassword.title')}</Text>
        <Text c="dimmed" ta="center">{t('setupPassword.subtitle')}</Text>

        {keys && (
          <Paper p="sm" withBorder w="100%">
            <Text size="xs" c="dimmed" mb={4}>{t('setupPassword.yourPublicKey')}</Text>
