...
import { Center, Stack, Text, ThemeIcon, PasswordInput, Button, Alert, Divider } from '@mantine/core'
      ...
      <Stack align="center" gap="lg" maw={320} w="100%">
        ...
        <form onSubmit={handleSubmit} style={{ width: '100%' }}>
          <Stack gap="md">
            ...
            >
              {isLockedOut ? formatRemainingTime(remainingTime) : t('lockScreen.unlock')}
            </Button>
