...
export default function ChatList({ onSelectChat }: ChatListProps) {
  ...
  return (
    <>
      <Stack gap={0} h="100%" style={{ overflow: 'auto', overscrollBehaviorY: 'none' }}>
        {chats.map((chat) => (
          <Box
            key={chat.pubkey}
            pos="relative"
          ...
          >
            ...
            >
              <Button color="red" h="100%" radius={0} onClick={() => setConfirmDelete(chat.pubkey)}>
                {t('common.delete')}
              </Button>
            </Box>
            ...
            >
              <Group wrap="nowrap" gap="sm">
                <Avatar src={getContactPicture(chat.pubkey)} size={48} radius="xl" color="cyan">
