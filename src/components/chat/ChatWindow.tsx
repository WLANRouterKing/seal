...
export default function ChatWindow({contactPubkey, contact, isBlocked, onBack}: ChatWindowProps) {
    ...
    return (
        <>
            ...
            <Stack h="100%" gap={0}>
                ...
                <Paper p="sm" radius={0} style={{borderBottom: '1px solid var(--mantine-color-dark-4)'}}>
                    <Group gap="sm">
                        ...
                        <Menu shadow="md" width={160} position="bottom-end">
                            <Menu.Target>
                                <Tooltip label={`${t('chat.disappearingMessages')}: ${expirationLabel}`}
                                         position="left">
                                    <ActionIcon
                ...
                {/* Input */}
                <MessageInput contactBlocked={isBlocked}  onSend={handleSend} onSendFile={handleSendFile}/>
            </Stack>
        </>
    )
}
